...
# %%
# !pip install git+https://github.com/Felhof/TransformerLens.git@support-mistral-7B
...
model_checkpoint = "mistral-7B"
# %%
hf_model = AutoModelForCausalLM.from_pretrained("mistralai/Mistral-7B-v0.1", torch_dtype=torch.float16)
tokenizer = AutoTokenizer.from_pretrained("mistralai/Mistral-7B-v0.1")

# %%
cfg = loading.get_pretrained_model_config("mistralai/Mistral-7B-v0.1", torch_dtype=torch.float16)
...
# %%
state_dict = loading.get_pretrained_state_dict("mistralai/Mistral-7B-v0.1", cfg, hf_model, torch_dtype=torch.float16)
